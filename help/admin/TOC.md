...
+ 형식{#formats}
   + [형식 개요](formats/formats.md)
   + [아웃바운드에 대한 Hadoop 시퀀스 파일 전송 활성화](formats/enable-outbound-seq.md)
...
+ OAuth2 클라이언트{#oath2-clients}
   ...
   + [API 요구 사항 및 Recommendations](admin-oauth2/aam-admin-api-requirements.md)
+ [감사 로깅](admin-audit-logging.md)
+ [내 프로필](admin-my-profile.md)
+ [대상 설정 문제 해결](admin-destination-troubleshooting.md)
+ [Beta 환경](admin-beta-environment.md)
