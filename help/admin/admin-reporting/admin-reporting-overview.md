...
새 보고서를 만들거나 기존 보고서를 편집 또는 삭제하여 Audience Manager 보고서를 관리합니다. 포털 사용자를 [!DNL Tableau] 사용자로 할당할 수도 있습니다.
...
[!UICONTROL Search] 상자나 목록 맨 아래에 있는 페이지 매김 컨트롤을 사용하여 원하는 보고서를 찾습니다.
