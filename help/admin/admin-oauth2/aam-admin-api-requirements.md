...
고객이 Audience Manager [!DNL API]을(를) 사용하여 작업할 때 인식하도록 권장해야 하는 사항입니다.
...
Audience Manager [!DNL API]을(를) 사용하기 위해 별도의 기술 사용자 계정을 만드는 것이 좋습니다. 이는 클라이언트 조직의 특정 사용자에게 연결되거나 연결되지 않은 일반 계정입니다. 이 유형의 [!DNL API] 사용자 계정은 다음 두 가지 작업을 수행하는 데 도움이 됩니다.
