...
1. 다음 필드를 채웁니다.
   ...
   * **[!UICONTROL Subdomain]**: (필수) 회사의 하위 도메인을 지정합니다. 입력한 텍스트는 이벤트 호출의 하위 도메인으로 표시됩니다. 이는 변경할 수 없습니다. [!DNL URL]자 문자열이어야 합니다.
     ...
     Audience Manager은 [!UICONTROL Data Collection Server]&#x200B;(DCS)에 하위 도메인을 사용합니다. 앞의 예제에서 회사의 [!DNL URL]에 있는 전체 [!UICONTROL DCS]은(는) [!DNL acmecorp.demdex.net]입니다.
...
Audience Manager [!UICONTROL Companies] 도구의 [!UICONTROL Admin] 페이지를 사용하여 기존 회사를 삭제합니다.
...
1. 원하는 회사의 ![](assets/icon_delete.png) 열에서 **[!UICONTROL Actions]**&#x200B;을(를) 클릭합니다.
